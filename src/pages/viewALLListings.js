...
const ViewAllListings = () => {
  ...
  const phrases = [
    "Welcome to DigiMitra!",
    "TICK TOCK SOLD!!",
    "View your favorite Product!",
  ...
  Wait is Over We're Bringing <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500">your Product....</span>
  </p>
